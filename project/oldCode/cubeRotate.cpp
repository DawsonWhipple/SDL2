...
* Date:           3/8/24
* Description:    Rotates a cube by drawing a series of pixels for each line and vertice
*                 Calculates angles and rotation each frame
...
*	- Rotate a 3d cube (cubeRotate.cpp)
****************************************************************************/
...
const int X_WINDOW_CENTER = WINDOW_WIDTH/2;
